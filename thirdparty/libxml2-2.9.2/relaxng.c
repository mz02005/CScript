                         ...
                         const xmlChar * arg2)
{
    ...
    switch (err) {
        ...
        case XML_RELAXNG_ERR_TYPE:
            _snprintf(msg, 1000, "failed to validate type %s\n", arg1);
            break;
        case XML_RELAXNG_ERR_TYPEVAL:
            _snprintf(msg, 1000, "Type %s doesn't allow value '%s'\n", arg1,
                     arg2);
            break;
        case XML_RELAXNG_ERR_DUPID:
            _snprintf(msg, 1000, "ID %s redefined\n", arg1);
            break;
        case XML_RELAXNG_ERR_TYPECMP:
            _snprintf(msg, 1000, "failed to compare type %s\n", arg1);
            break;
        ...
        case XML_RELAXNG_ERR_INTERNAL:
            _snprintf(msg, 1000, "Internal error: %s\n", arg1);
            break;
        case XML_RELAXNG_ERR_LISTEXTRA:
            _snprintf(msg, 1000, "Extra data in list: %s\n", arg1);
            break;
        ...
        case XML_RELAXNG_ERR_INTEREXTRA:
            _snprintf(msg, 1000, "Extra element %s in interleave\n", arg1);
            break;
        case XML_RELAXNG_ERR_ELEMNAME:
            _snprintf(msg, 1000, "Expecting element %s, got %s\n", arg1,
                     arg2);
            break;
        case XML_RELAXNG_ERR_ELEMNONS:
            _snprintf(msg, 1000, "Expecting a namespace for element %s\n",
                     arg1);
            break;
        ...
        case XML_RELAXNG_ERR_ELEMWRONG:
            _snprintf(msg, 1000, "Did not expect element %s there\n", arg1);
            break;
        ...
        case XML_RELAXNG_ERR_ELEMEXTRANS:
            _snprintf(msg, 1000, "Expecting no namespace for element %s\n",
                     arg1);
            break;
        case XML_RELAXNG_ERR_ELEMNOTEMPTY:
            _snprintf(msg, 1000, "Expecting element %s to be empty\n", arg1);
            break;
        case XML_RELAXNG_ERR_NOELEM:
            _snprintf(msg, 1000, "Expecting an element %s, got nothing\n",
                     arg1);
            break;
        case XML_RELAXNG_ERR_NOTELEM:
            return (xmlCharStrdup("Expecting an element got text\n"));
        case XML_RELAXNG_ERR_ATTRVALID:
            _snprintf(msg, 1000, "Element %s failed to validate attributes\n",
                     arg1);
            break;
        case XML_RELAXNG_ERR_CONTENTVALID:
            _snprintf(msg, 1000, "Element %s failed to validate content\n",
                     arg1);
            break;
        case XML_RELAXNG_ERR_EXTRACONTENT:
            _snprintf(msg, 1000, "Element %s has extra content: %s\n",
                     arg1, arg2);
            break;
        case XML_RELAXNG_ERR_INVALIDATTR:
            _snprintf(msg, 1000, "Invalid attribute %s for element %s\n",
                     arg1, arg2);
            break;
        case XML_RELAXNG_ERR_LACKDATA:
            _snprintf(msg, 1000, "Datatype element %s contains no data\n",
                     arg1);
            break;
        case XML_RELAXNG_ERR_DATAELEM:
            _snprintf(msg, 1000, "Datatype element %s has child elements\n",
                     arg1);
            break;
        case XML_RELAXNG_ERR_VALELEM:
            _snprintf(msg, 1000, "Value element %s has child elements\n",
                     arg1);
            break;
        case XML_RELAXNG_ERR_LISTELEM:
            _snprintf(msg, 1000, "List element %s has child elements\n",
                     arg1);
            break;
        case XML_RELAXNG_ERR_DATATYPE:
            _snprintf(msg, 1000, "Error validating datatype %s\n", arg1);
            break;
        case XML_RELAXNG_ERR_VALUE:
            _snprintf(msg, 1000, "Error validating value %s\n", arg1);
            break;
    ...
    if (msg[0] == 0) {
        _snprintf(msg, 1000, "Unknown error code %d\n", err);
    }
    msg[1000 - 1] = 0;
...
xmlRelaxNGParseInterleave(xmlRelaxNGParserCtxtPtr ctxt, xmlNodePtr node)
{
    ...
    if (ctxt->interleaves == NULL) {
        ...
        _snprintf(name, 32, "interleave%d", ctxt->nbInterleaves++);
                       ...
                       xmlRelaxNGParserCtxtPtr ctxt, const xmlChar * name)
{
    ...
    if (choiceOrInterleave == 0) {
        ...
        if (ctxt->interleaves == NULL) {
            ...
            _snprintf(tmpname, 32, "interleave%d", ctxt->nbInterleaves++);
